...
const getInvoice = async () => {
    const apiUrl = '/api/edit_invoice/'+ props.id
...
<template>
            ...
            <div class="card__content--header">
                <div>
                    ...
                    <select name="" id="" class="input" v-model="form.customer_id">
                        ...
                        <option :value="customer.id" v-for="customer in allcustomers" :key="customer.id">{{ customer.first_name }}</option>
                    </select>
                </div>
                <div>
                    <p class="my-1">Date</p> 
    ...
    <div class="modal main__modal " :class="{ show:showModel }">
        <div class="modal__content">
            ...
            <button @click="addCart(item)" style="border: 1px solid #e0e0e0;width: 35px;height: 35px;cursor: pointer;"></button></li></ul>
            </div>
            <br><hr>
